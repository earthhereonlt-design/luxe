...
export default function AddProductPage() {
  ...
  const [formData, setFormData] = React.useState<Partial<ProductInput>>({
    title: '',
    affiliate_link: '',
    price: 0,
    currency: 'USD',
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      setFormData(prev => ({
        ...prev,
        ...generated,
        // Keep the original link if AI returns a dummy or if we want to ensure it sticks
  ...
  const handleSave = async (e: React.FormEvent) => {
    e.preventDefault();
    if (!formData.title || !formData.affiliate_link || !formData.description) {
      alert('Missing required fields. Please ensure Title, Link, and Description (via AI) are present.');
      return;
    }
            ...
            <div className="space-y-4">
              <div className="space-y-1">
                ...
                <input
                  ...
                  className="w-full px-4 py-3 bg-gray-50 border border-gray-100 rounded-xl outline-none focus:border-blue-500 transition-all"
                />
              </div>

              <div className="space-y-1">
                <label className="text-xs font-bold uppercase tracking-widest text-gray-400">Affiliate Link</label>
                <input
                  type="url"
              ...
              <div className="pt-4">
                ...
                >
                  ...
                  <span>{isGenerating ? 'Gemini is writing...' : 'Generate with AI'}</span>
                </button>
                <p className="mt-3 text-[10px] text-center text-gray-400 uppercase tracking-widest flex items-center justify-center">
                   <Info className="w-3 h-3 mr-1" />
                   AI will generate descriptions, SEO, and tags
                </p>
              </div>
            </div>
          </section>
                ...
                <div className="space-y-4">
                  <div className="space-y-1">
                    ...
                    <textarea
                      ...
                      className="w-full px-4 py-3 bg-gray-50 border border-gray-100 rounded-xl outline-none focus:border-blue-500 transition-all resize-none"
                    />
                  </div>

                  <div className="space-y-1">
                    <label className="text-xs font-bold uppercase tracking-widest text-gray-400">Main Description</label>
                    <textarea
                      rows={6}
                     ...
                     <div className="space-y-1">
                        ...
                        <div className="relative">
                          <select 
                            ...
                            className="w-full pl-4 pr-10 py-3 bg-gray-50 border border-gray-100 rounded-xl outline-none focus:border-blue-500 transition-all appearance-none"
                          >
        ...
        <div className="lg:col-span-4 space-y-8">
           ...
           <section className="bg-white p-6 rounded-3xl border border-gray-100 shadow-sm space-y-4">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-1">
                  <label className="text-[10px] font-bold uppercase tracking-widest text-gray-400">Tags (CSV)</label>
                  <input
                    type="text"
